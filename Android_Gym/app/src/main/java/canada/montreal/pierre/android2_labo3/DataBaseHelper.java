...
@Database(entities = {Gym.class,GymExercice.class,Video.class}, version = 1)
public abstract class DataBaseHelper extends RoomDatabase {
    ...
    public static synchronized DataBaseHelper getInstance(Context context){
        ...
        if(dataBaseInstance==null){
            ...
            dataBaseInstance = Room.databaseBuilder(context.getApplicationContext(), DataBaseHelper.class,DATABASE_NAME).build();
        }

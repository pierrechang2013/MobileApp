...
public class ListActivityInstrumentedTest {
    ...
    public void insertData(){
        ...
        Gym p1 = new Gym("aaa","Boissons" );
        Gym p2 = new Gym("aaa","Boissons" );
        Gym p3 = new Gym("bbb","Condiments" );
        Gym p4 = new Gym("bbb","sdsdfsdf" );
        Gym p5 = new Gym("bbb","wrwerewrw" );
        Gym p6 = new Gym("bbb","ououiououi" );
        Gym p7 = new Gym("aaa","jljklkjl35" );
        Gym p8 = new Gym("aaa","5435435sdfsdfsd" );
        Gym p9 = new Gym("aaa","08908sdfdsf" );
        Gym p10 = new Gym("aaa","zvbzxbnbmnm" );
